          ...
          <SwiperSlide key={slide.id}>
            ...
            >
                    ...
                    <div className="max-w-3xl lg:max-w-2xl 2xl:max-w-3xl">
                      ...
                      <div className="mb-8 lg:mb-6 2xl:mb-8">
                        ...
                        <motion.button
                          ...
                          className="inline-flex items-center px-6 py-3 lg:px-5 lg:py-2.5 2xl:px-6 2xl:py-3 rounded-lg font-semibold lg:text-sm 2xl:text-base cursor-pointer"
                          style={{
                            backgroundColor:
                      ...
                      <div className="flex items-center space-x-6 lg:space-x-4 2xl:space-x-6">
                        {finalSlides.map((_, index) => (
                          <motion.button
                            ...
                            className={`relative text-base lg:text-sm 2xl:text-base font-medium cursor-pointer ${
                              activeIndex === index
                                ? "text-white"
              ...
              <motion.button
                ...
                className="absolute top-1/2 left-8 md:left-16 lg:left-12 2xl:left-16 transform -translate-y-1/2 w-12 h-12 lg:w-10 lg:h-10 2xl:w-12 2xl:h-12 backdrop-blur-sm rounded-full flex items-center justify-center z-10 border border-white transition-all duration-300 hover:bg-white/30 hover:scale-110 hover:shadow-lg cursor-pointer"
              ...
              <motion.button
                ...
                className="absolute top-1/2 right-8 md:right-16 lg:right-12 2xl:right-16 transform -translate-y-1/2 w-12 h-12 lg:w-10 lg:h-10 2xl:w-12 2xl:h-12 backdrop-blur-sm rounded-full flex items-center justify-center z-10 border border-white transition-all duration-300 hover:bg-white/30 hover:scale-110 hover:shadow-lg cursor-pointer"
                initial={{ opacity: 0, x: 20 }}
                animate={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.5, delay: 1.2, ease: "easeOut" }}
                whileHover={{
