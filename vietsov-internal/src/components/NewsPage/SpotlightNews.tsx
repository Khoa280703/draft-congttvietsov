...
const SpotlightNews: React.FC = () => {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 lg:gap-5 inch32:gap-6 pb-8 md:pb-12 lg:pb-10 inch32:pb-12">
      <article className="lg:col-span-3">
        ...
        >
          ...
          <h1 className="text-3xl md:text-4xl lg:text-3xl inch32:text-4xl font-bold text-gray-900 mb-4 lg:mb-3 inch32:mb-4 leading-tight">
            {mainArticleData.title}
          </h1>

          <p className="text-base lg:text-sm inch32:text-base text-gray-600 leading-relaxed">
