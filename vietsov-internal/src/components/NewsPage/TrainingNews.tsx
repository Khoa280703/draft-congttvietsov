  ...
  return (
    <article className="group">
      <a href="#">
        ...
        <h3 className="mt-4 text-lg font-bold leading-tight text-gray-800 group-hover:text-green-600 transition-colors">
          {article.title}
        </h3>
...
const SimpleArticleLink: React.FC<SimpleArticleLinkProps> = ({ article }) => {
  return (
    <article className="group">
      <a href="#">
        <h3 className="text-lg font-bold leading-tight text-gray-800 group-hover:text-green-600 transition-colors">
          {article.title}
        </h3>
        <p className="mt-2 text-sm text-gray-500">{article.timestamp}</p>
      </a>
    </article>
  );
};
