...
const CardSimple: React.FC<CardSimpleProps> = ({
  ...
  return (
    <motion.div
      ...
      onClick={onClick}
    >
      <div className="relative w-full h-72 md:h-80 lg:h-64 inch32:h-80 overflow-hidden">
        <img
          src={imageUrl}
          alt={imageAlt}
      ...
      <div className="p-6 md:p-8 lg:p-6 inch32:p-8 space-y-3 md:space-y-4 lg:space-y-3 inch32:space-y-4 text-center py-6 md:py-8 lg:py-6 inch32:py-8">
        <motion.h3
