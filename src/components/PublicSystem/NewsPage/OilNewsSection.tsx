...
const sideArticles = [
  {
    id: 1,
    title:
      "Xí nghiệp Địa vật lý giếng khoan sẻ chia khó khăn cùng đồng bào chịu ảnh hưởng bão Yagi",
          ...
          <div className="space-y-4">
            {sideArticles.map((article) => (
              <a
                href="#"
                key={article.id}
                className="flex items-center space-x-4 group border-b-1 border-gray-300 pb-4 last:border-b-0"
              >
                <img
                  src={article.image}
                  alt={article.title}
                ...
                <div className="flex-grow">
                  <h4 className="font-semibold text-gray-800 group-hover:text-blue-600 transition-colors leading-snug h-14">
                    {article.title}
                  </h4>
