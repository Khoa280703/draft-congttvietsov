...
export interface CommunityActivityPageData {
  id: number;
  image: string;
  imageAlt: string;
  category: string;
...
export interface CommunityActivityPageSectionProps {
  className?: string;
}

export const defaultCommunityActivityPageData: CommunityActivityPageData[] = [
  {
    id: 1,
    image: giaiBongDa,
