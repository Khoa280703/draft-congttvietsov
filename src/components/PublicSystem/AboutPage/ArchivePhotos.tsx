          ...
          <div className="lg:col-span-2">
            <div className="relative group">
              ...
              >
                ...
                <button className="image-swiper-button-prev absolute top-1/2 -translate-y-1/2 left-4 z-10 p-2 bg-white/20 rounded-full border-1 border-white text-white hover:bg-white/40 transition-colors cursor-pointer opacity-0 group-hover:opacity-100 swiper-button-disabled:opacity-20">
                  <FiChevronLeft size={24} />
                </button>
                <button className="image-swiper-button-next absolute top-1/2 -translate-y-1/2 right-4 z-10 p-2 bg-white/20 rounded-full border-1 border-white text-white hover:bg-white/40 transition-colors cursor-pointer opacity-0 group-hover:opacity-100 swiper-button-disabled:opacity-20">
