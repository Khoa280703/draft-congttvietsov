...
const ATSKMTSection: React.FC = () => {
  ...
  const featuredArticle = atskmtArticles.find((article) => article.featured);
  const regularArticles = atskmtArticles.filter((article) => !article.featured);
      ...
      >
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl font-bold text-gray-900">
            Bài viết về an toàn sức khỏe môi trường
          </h2>
        </div>
